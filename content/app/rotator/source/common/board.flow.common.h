...
#define CMD_LINE_DRIVER_PROTO_ID 6
#define CMD_LINE_DRIVER_ECHO_ID 7
#define CMD_JOINT_VECTOR_A_ID 8
#define CMD_JOINT_VECTOR_B_ID 9
#define CMD_JOINT_VECTOR_A_ENABLED 1
#define CMD_JOINT_VECTOR_B_ENABLED 1
...
#define  joint_FLOW_CMD_JOINT_VECTOR_A CMD_JOINT_VECTOR_A_ID
#define  joint_FLOW_CAN0_JOINT_VECTOR_A_SUBA 0xA
#define  joint_FLOW_CAN0_JOINT_VECTOR_A_SUBA_ANSW 0xFF
#define  joint_FLOW_CMD_JOINT_VECTOR_B CMD_JOINT_VECTOR_B_ID
#define  joint_FLOW_CAN0_JOINT_VECTOR_B_SUBA 0xC
#define  joint_FLOW_CAN0_JOINT_VECTOR_B_SUBA_ANSW 0xFF


#define joint_snapshot_t manmotor_snapshot_t
#define joint_control_data_t manmotor_control_data_t
#define joint_snapshot_update manmotor_snapshot_update
#define joint_snapshot_encode manmotor_snapshot_encode
#define joint_SNAPSHOT_DATA_SIZE manmotor_SNAPSHOT_DATA_SIZE

#include "board.flow.tuning.h"

#include "manmotor.flow.proto.h"
